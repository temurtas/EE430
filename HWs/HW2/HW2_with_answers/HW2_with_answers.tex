...
\begin{enumerate}
	\item 1st Question
		...
		\end{figure}
			...
			\includepdf[landscape=false,pages=1-6, scale=0.9,angle=0,pagecommand=]{../images/Q3s.pdf}
	...
	\item 4th Question
		...
		\begin{figure}[H]
			\center
			\setlength{\unitlength}{\textwidth} 
			\includegraphics[width=1.0\unitlength]{../images/Q8s}
			\caption{\label{fig:Q4s}Q4s }
		\end{figure}
	...
	\item 5th Question
		\begin{figure}[H]
			\center
			\setlength{\unitlength}{\textwidth} 
			\includegraphics[width=1.0\unitlength]{../images/Q9}
			\caption{\label{fig:Q5}Q5 }
		\end{figure}
		
		\begin{figure}[H]
			\center
			\setlength{\unitlength}{\textwidth} 
			\includegraphics[width=1.0\unitlength]{../images/Q9s}
			\caption{\label{fig:Q5s}Q5s }
		\end{figure}
	...
	\begin{figure}[H]
			\center
			\setlength{\unitlength}{\textwidth} 
			\includegraphics[width=1.0\unitlength]{../images/Q11-12-13}
			\caption{\label{fig:Q1223}Q11-12-13 }
		\end{figure}		
	...
	\item 6th Question
		\begin{figure}[H]
			\center
			\setlength{\unitlength}{\textwidth} 
			\includegraphics[width=1.0\unitlength]{../images/Q11}
			\caption{\label{fig:Q6}Q6 }
		\end{figure}
	...
	\item 8th Question
		...
		\begin{figure}[H]
			\center
			\setlength{\unitlength}{\textwidth} 
			\includegraphics[width=1.0\unitlength]{../images/Q13s}
			\caption{\label{fig:Q8s}Q8s }
		\end{figure}
	...
	\item 9th Question
		\begin{figure}[H]
			\center
			\setlength{\unitlength}{\textwidth} 
			\includegraphics[width=1.0\unitlength]{../images/Q34}
			\caption{\label{fig:Q9}Q9 }
		\end{figure}
